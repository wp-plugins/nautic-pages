...
function nautic_pages_previous($sortby = 'post_title'){
	...
	if(sizeof($current_path) AND $current_page){
		...
		$link = '<a '.$class.' href="' . get_page_link($previous) . '"  title="' . attribute_escape(apply_filters('the_title', $page['post_title'])) . '">' . apply_filters('the_title', $page['post_title']) . '</a>';
...
function nautic_pages_next($sortby = 'post_title'){
	...
	if(sizeof($current_path) AND $current_page){
		...
		$link = '<a '.$class.' href="' . get_page_link($next) . '"  title="' . attribute_escape(apply_filters('the_title', $page['post_title'])) . '">' . apply_filters('the_title', $page['post_title']) . '</a>';
...
function nautic_pages_path($args){
	...
	if(sizeof($current_path) AND $current_page){
	    ...
	    if($page['current'] == 'current_page_item' AND $show_latest)
				...
				$html .= '<a '.$class.'href="' . get_page_link($ID) . '" title="' . attribute_escape(apply_filters('the_title', $page['post_title'])) . '">' . apply_filters('the_title', $page['post_title']) . '</a>';
				$html .= $separator;
			}
...
//echo '<pre>'; print_r( $options ); echo '</pre>';
    ...
    if($page['current'] == 'current_page_item' AND !$options['aslink'])
			...
			$html .= '<a href="' . get_page_link($key) . '" title="' . attribute_escape(apply_filters('the_title', $page['post_title'])) . '">' . apply_filters('the_title', $page['post_title']) . '</a>';
